...
#define KD_VT_ABSOLUTE      0
#define KD_VT_RELATIVE      1
...
typedef struct _KdPointerDriver {
    ...
    Status                  (*Control) (KdPointerInfo *, int, void *);
    struct _KdPointerDriver *next;
} KdPointerDriver;

typedef struct _KdInputDevice {
    int type;
    char *name;
    char *path;
    DeviceIntPtr dixdev;
...
typedef struct _KdKeyboardDriver {
    ...
    Status                (*Control) (KdKeyboardInfo *, int, void *);
